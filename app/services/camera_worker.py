...
async def process_frame_and_mark(frame_bgr):  # ← Make async
...
def run_camera_loop():
    """Live camera attendance system - FIXED async handling."""
    ...
    loop = asyncio.new_event_loop()  # ← Dedicated persistent loop
    ...
    try:
        while cap.isOpened():
            ...
            # Run async frame processing in dedicated loop
            ...
            cv2.imshow("YOLO Attendance System - FIXED", frame)
